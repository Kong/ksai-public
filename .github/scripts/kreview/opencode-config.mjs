...
if (!['text', 'tool'].includes(resultTransport) || (resultTransport === 'tool' && phase !== 'review')) {
...
else if (phase === 'review' && resultTransport === 'tool') config.default_agent = 'ksai-review-submit';
