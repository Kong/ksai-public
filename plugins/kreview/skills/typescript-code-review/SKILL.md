...
- 80 TypeScript and JavaScript mistakes catalog: [knowledge-base.md](knowledge-base.md)
- TypeScript traps the auditor applies (`stack_quirks`): [audit-quirks.md](audit-quirks.md)
